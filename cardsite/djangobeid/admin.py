...
class PersonneAdmin(admin.ModelAdmin):
    fieldsets = [
        ...
        ('Autorisation', {"fields" : ["acces_autorise"]}),
    ...
    list_display = ['nom','prenoms','sexe','date_naissance','lieu_naissance','nationalite','code_postal','commune','card_is_valid', 'acces_autorise']
